...
class TestValidateAllScopes:
    def test_all_present(self):
        assert gopher_auth_validate_all_scopes("openid mcp:read mcp:admin", "mcp:read mcp:admin") is True
    def test_one_missing(self):
        assert gopher_auth_validate_all_scopes("openid mcp:read", "mcp:read mcp:admin") is False
...
class TestValidateAnyScopes:
    def test_one_present(self):
        assert gopher_auth_validate_any_scopes("openid mcp:read", "mcp:read mcp:admin") is True
