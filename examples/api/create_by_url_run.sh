...
# Run the Python SDK example for GopherAgent.create_with_url against the
# PyPI-published gopher-mcp-python package. Bootstraps a fresh venv,
...
# published version is installed. create_with_url requires a release
# that includes the native routing factory symbols.
