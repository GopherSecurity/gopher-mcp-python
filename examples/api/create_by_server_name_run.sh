...
# Run the Python SDK example for GopherAgent.create_with_server_name
...
detect_platform
print_banner "GopherAgent.create_with_server_name example"

warn_if_empty "GOPHER_API_KEY" "Set it with: export GOPHER_API_KEY=your_api_key"
warn_if_empty "GOPHER_MCP_SERVER_NAME" "Set it with: export GOPHER_MCP_SERVER_NAME=my-server"
...
run_api_example "test-project-create-by-server-name" "create_by_server_name.py" "$@"
