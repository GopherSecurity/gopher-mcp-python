...
# against the PyPI-published gopher-mcp-python package. Bootstraps a
...
echo -e "${GREEN}============================================${NC}"
echo -e "${GREEN}GopherAgent.create_with_server_name example${NC}"
echo -e "${GREEN}============================================${NC}"
echo ""
...
cp "$SCRIPT_DIR/create_by_server_name.py" .

echo ""
echo -e "${YELLOW}Running example...${NC}"
echo ""
python create_by_server_name.py "$@"
