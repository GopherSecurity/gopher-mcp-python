...
def main() -> None:
    ...
    print("Env:   GOPHER_API_KEY GOPHER_MCP_SERVER_NAME LLM_PROVIDER LLM_MODEL DEBUG")
    print("")
    ...
    agent = GopherAgent.create_with_server_name(provider, model, api_key, server_name)
